...
namespace MTL {
    ...
    public:
        ...
        void getBytes(void *bytes, const MTL::TensorExtents *strides, const MTL::TensorExtents *sliceOrigin,
                      const MTL::TensorExtents *sliceDimensions);

        void getBytes(void *bytes, const MTL::TensorExtents *strides, const MTL::TensorExtents *sliceOrigin,
                      const MTL::TensorExtents *sliceDimensions, MTL::TensorPlaneType plane);

        ResourceID gpuResourceID() const;

        void replaceSliceOrigin(const MTL::TensorExtents *sliceOrigin, const MTL::TensorExtents *sliceDimensions,
...
_MTL_INLINE MTL::TensorAuxiliaryPlaneDescriptorMap *MTL::TensorAuxiliaryPlaneDescriptorMap::alloc() {
    return NS::Object::alloc<MTL::TensorAuxiliaryPlaneDescriptorMap>(
        _MTL_PRIVATE_CLS(MTLTensorAuxiliaryPlaneDescriptorMap));
}

_MTL_INLINE MTL::TensorAuxiliaryPlaneDescriptor *MTL::TensorAuxiliaryPlaneDescriptorMap::descriptor(
    MTL::TensorPlaneType plane) {
    return Object::sendMessage<MTL::TensorAuxiliaryPlaneDescriptor *>(this, _MTL_PRIVATE_SEL(descriptorForPlane_),
                                                                      plane);
}
...
_MTL_INLINE void MTL::TensorAuxiliaryPlaneDescriptorMap::setDescriptor(
    const MTL::TensorAuxiliaryPlaneDescriptor *descriptor, MTL::TensorPlaneType plane) {
...
_MTL_INLINE void MTL::TensorDescriptor::setAuxiliaryPlanes(
    const MTL::TensorAuxiliaryPlaneDescriptorMap *auxiliaryPlanes) {
...
_MTL_INLINE void MTL::TensorBufferAttachments::setBuffer(const MTL::Buffer *buffer, NS::UInteger offset,
                                                         MTL::TensorPlaneType plane) {
...
_MTL_INLINE void MTL::Tensor::getBytes(void *bytes, const MTL::TensorExtents *strides,
                                       const MTL::TensorExtents *sliceOrigin,
                                       const MTL::TensorExtents *sliceDimensions) {
    Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(getBytes_strides_fromSliceOrigin_sliceDimensions_), bytes, strides,
                              sliceOrigin, sliceDimensions);
}

_MTL_INLINE void MTL::Tensor::getBytes(void *bytes, const MTL::TensorExtents *strides,
                                       const MTL::TensorExtents *sliceOrigin, const MTL::TensorExtents *sliceDimensions,
                                       MTL::TensorPlaneType plane) {
    Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(getBytes_strides_fromSliceOrigin_sliceDimensions_plane_), bytes,
                              strides, sliceOrigin, sliceDimensions, plane);
}
...
_MTL_INLINE void MTL::Tensor::replaceSliceOrigin(const MTL::TensorExtents *sliceOrigin,
                                                 const MTL::TensorExtents *sliceDimensions, const void *bytes,
                                                 const MTL::TensorExtents *strides) {
    Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(replaceSliceOrigin_sliceDimensions_withBytes_strides_),
                              sliceOrigin, sliceDimensions, bytes, strides);
}

_MTL_INLINE void MTL::Tensor::replaceSliceOrigin(const MTL::TensorExtents *sliceOrigin,
                                                 const MTL::TensorExtents *sliceDimensions, MTL::TensorPlaneType plane,
                                                 const void *bytes, const MTL::TensorExtents *strides) {
    Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(replaceSliceOrigin_sliceDimensions_plane_withBytes_strides_),
                              sliceOrigin, sliceDimensions, plane, bytes, strides);
}
