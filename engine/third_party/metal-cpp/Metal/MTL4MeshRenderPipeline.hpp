...
MTL4::MeshRenderPipelineDescriptor::colorAttachments() const {
...
_MTL_INLINE void
MTL4::MeshRenderPipelineDescriptor::setSupportFragmentBinaryLinking(bool supportFragmentBinaryLinking) {
...
MTL4::MeshRenderPipelineDescriptor::supportIndirectCommandBuffers() const {
