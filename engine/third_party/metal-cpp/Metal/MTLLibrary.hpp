...
namespace MTL {
    ...
    public:
        ...
        void setFloatingPointConversionRoundingMode(
            MTL::FloatingPointConversionRoundingMode floatingPointConversionRoundingMode);
    ...
    public:
        ...
        Function *newFunction(const NS::String *name, const MTL::FunctionConstantValues *constantValues,
                              NS::Error **error);

        void newFunction(const NS::String *name, const MTL::FunctionConstantValues *constantValues,
                         void (^completionHandler)(MTL::Function *, NS::Error *)

        );

        void newFunction(const MTL::FunctionDescriptor *descriptor, void (^completionHandler)(
            MTL::Function *, NS::Error *)

        );

        Function *newFunction(const MTL::FunctionDescriptor *descriptor, NS::Error **error);

        void newFunction(const NS::String *pFunctionName, const MTL::FunctionConstantValues *pConstantValues,
                         const MTL::FunctionCompletionHandlerFunction &completionHandler);

        void newFunction(const MTL::FunctionDescriptor *pDescriptor,
                         const MTL::FunctionCompletionHandlerFunction &completionHandler);

        void newIntersectionFunction(const MTL::IntersectionFunctionDescriptor *descriptor, void (^completionHandler)(
            MTL::Function *, NS::Error *)
...
_MTL_INLINE MTL::ArgumentEncoder *MTL::Function::newArgumentEncoder(NS::UInteger bufferIndex) {
    return Object::sendMessage<MTL::ArgumentEncoder *>(this, _MTL_PRIVATE_SEL(newArgumentEncoderWithBufferIndex_),
                                                       bufferIndex);
}
...
_MTL_INLINE MTL::FloatingPointConversionRoundingMode MTL::CompileOptions::floatingPointConversionRoundingMode() const {
    return Object::sendMessage<MTL::FloatingPointConversionRoundingMode>(
        this, _MTL_PRIVATE_SEL(floatingPointConversionRoundingMode));
}
...
_MTL_INLINE void MTL::CompileOptions::setAllowReferencingUndefinedSymbols(bool allowReferencingUndefinedSymbols) {
    Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setAllowReferencingUndefinedSymbols_),
...
_MTL_INLINE void MTL::CompileOptions::setFloatingPointConversionRoundingMode(
    MTL::FloatingPointConversionRoundingMode floatingPointConversionRoundingMode) {
    Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(setFloatingPointConversionRoundingMode_),
...
_MTL_INLINE MTL::Function *MTL::Library::newFunction(const NS::String *name,
                                                     ...
                                                     NS::Error **error) {
    return Object::sendMessage<MTL::Function *>(this, _MTL_PRIVATE_SEL(newFunctionWithName_constantValues_error_), name,
                                                constantValues, error);
}

_MTL_INLINE void MTL::Library::newFunction(const NS::String *name, const MTL::FunctionConstantValues *constantValues,
                                           void (^completionHandler)(MTL::Function *, NS::Error *)
...
_MTL_INLINE void MTL::Library::newFunction(const MTL::FunctionDescriptor *descriptor, void (^completionHandler)(
    MTL::Function *, NS::Error *)
...
_MTL_INLINE MTL::Function *MTL::Library::newFunction(const MTL::FunctionDescriptor *descriptor, NS::Error **error) {
    return Object::sendMessage<MTL::Function *>(this, _MTL_PRIVATE_SEL(newFunctionWithDescriptor_error_), descriptor,
                                                error);
}
...
_MTL_INLINE MTL::Function *MTL::Library::newIntersectionFunction(const MTL::IntersectionFunctionDescriptor *descriptor,
                                                                 NS::Error **error) {
    return Object::sendMessage<MTL::Function *>(this, _MTL_PRIVATE_SEL(newIntersectionFunctionWithDescriptor_error_),
                                                descriptor, error);
}

_MTL_INLINE void MTL::Library::newIntersectionFunction(const MTL::IntersectionFunctionDescriptor *pDescriptor,
                                                       const MTL::FunctionCompletionHandlerFunction &
                                                       completionHandler) {
    __block MTL::FunctionCompletionHandlerFunction blockCompletionHandler = completionHandler;
...
_MTL_INLINE MTL::FunctionReflection *MTL::Library::reflectionForFunction(const NS::String *functionName) {
    return Object::sendMessage<MTL::FunctionReflection *>(this, _MTL_PRIVATE_SEL(reflectionForFunctionWithName_),
                                                          functionName);
}
