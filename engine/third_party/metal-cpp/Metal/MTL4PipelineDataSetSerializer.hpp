...
_MTL_INLINE MTL4::PipelineDataSetSerializerConfiguration
MTL4::PipelineDataSetSerializerDescriptor::configuration() const {
...
_MTL_INLINE bool
MTL4::PipelineDataSetSerializer::serializeAsArchiveAndFlushToURL(const NS::URL *url, NS::Error **error) {
