...
namespace MTL4 {
    ...
    public:
        ...
        void drawIndexedPrimitives(MTL::PrimitiveType primitiveType, NS::UInteger indexCount, MTL::IndexType indexType,
                                   MTL::GPUAddress indexBuffer, NS::UInteger indexBufferLength);
        ...
        void drawMeshThreadgroups(MTL::GPUAddress indirectBuffer, MTL::Size threadsPerObjectThreadgroup,
                                  MTL::Size threadsPerMeshThreadgroup);
        ...
        void writeTimestamp(MTL4::TimestampGranularity granularity, MTL::RenderStages stage,
...
_MTL_INLINE void MTL4::RenderCommandEncoder::drawIndexedPrimitives(MTL::PrimitiveType primitiveType,
    ...
    Object::sendMessage<void>(
        this, _MTL_PRIVATE_SEL(drawIndexedPrimitives_indexCount_indexType_indexBuffer_indexBufferLength_),
...
_MTL_INLINE void MTL4::RenderCommandEncoder::drawIndexedPrimitives(MTL::PrimitiveType primitiveType,
                                                                   ...
                                                                   NS::UInteger instanceCount) {
    Object::sendMessage<void>(
        this, _MTL_PRIVATE_SEL(drawIndexedPrimitives_indexCount_indexType_indexBuffer_indexBufferLength_instanceCount_),
        primitiveType, indexCount, indexType, indexBuffer, indexBufferLength, instanceCount);
}
...
_MTL_INLINE void MTL4::RenderCommandEncoder::drawIndexedPrimitives(MTL::PrimitiveType primitiveType,
    ...
    Object::sendMessage<void>(
        ...
        primitiveType, indexCount, indexType, indexBuffer, indexBufferLength, instanceCount, baseVertex, baseInstance);
}
...
_MTL_INLINE void MTL4::RenderCommandEncoder::drawIndexedPrimitives(MTL::PrimitiveType primitiveType,
                                                                   ...
                                                                   MTL::GPUAddress indirectBuffer) {
    Object::sendMessage<void>(
        this, _MTL_PRIVATE_SEL(drawIndexedPrimitives_indexType_indexBuffer_indexBufferLength_indirectBuffer_),
        primitiveType, indexType, indexBuffer, indexBufferLength, indirectBuffer);
}
...
_MTL_INLINE void MTL4::RenderCommandEncoder::drawMeshThreadgroups(MTL::GPUAddress indirectBuffer,
    ...
    Object::sendMessage<void>(
        this, _MTL_PRIVATE_SEL(
            drawMeshThreadgroupsWithIndirectBuffer_threadsPerObjectThreadgroup_threadsPerMeshThreadgroup_),
...
_MTL_INLINE void MTL4::RenderCommandEncoder::drawPrimitives(MTL::PrimitiveType primitiveType, NS::UInteger vertexStart,
...
_MTL_INLINE void MTL4::RenderCommandEncoder::setThreadgroupMemoryLength(NS::UInteger length, NS::UInteger offset,
                                                                        NS::UInteger index) {
...
_MTL_INLINE void MTL4::RenderCommandEncoder::writeTimestamp(MTL4::TimestampGranularity granularity,
                                                            ...
                                                            const MTL4::CounterHeap *counterHeap, NS::UInteger index) {
    Object::sendMessage<void>(this, _MTL_PRIVATE_SEL(writeTimestampWithGranularity_afterStage_intoHeap_atIndex_),
                              granularity, stage, counterHeap, index);
}
